...
<body>
                ...
                <div class="w-full px-[12px]">
                    <div class="bix-breadcrumb mt-[100px] py-[80px] overflow-hidden">
                        ...
                        <div class="breadcrumb-contact flex flex-col justify-center items-center z-[12] relative">
                            <h4 class="mb-[8px] font-montserrat text-[32px] font-semibold text-[#fff] capitalize tracking-[0.03rem] leading-[1.2] max-[991px]:mb-[4px] max-[991px]:text-[28px] max-[575px]:mb-[0] max-[575px]:text-[22px]">Blog Detail</h4>
                            <h5 class="cursor-default text-[#111a24] text-[1.25rem] leading-[1.2]">
                                ...
                                <span class="disable px-[2px] opacity-[0.7]">
                                    <a href="javascript:void(0)" class="font-montserrat leading-[26px] tracking-[0.03rem] text-[15px] font-normal text-[#fff] max-[575px]:text-[14px] cursor-default">Blog Detail</a>
                                </span>
                            </h5>
                        </div>
                    </div>
    ...
    <!-- Blog-details -->
    <section class="section section-blog-details pt-[50px] pb-[100px] max-[991px]:pt-[40px] max-[991px]:pb-[80px] max-[767px]:pt-[35px] max-[767px]:pb-[70px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="flex flex-wrap w-full mb-[-24px]">
                <div class="min-[992px]:w-[33.33%] w-full px-[12px] mb-[24px]">
                    <div class="bix-blog-sidebar border-[1px] border-solid border-[#eae8ef] rounded-[20px] bg-[#f7f5fb]">
                        <div class="inner-details border-b-[1px] border-solid border-[#eae8ef]">
                            <div class="blog-image pt-[24px] px-[24px] max-[575px]:px-[15px] max-[575px]:pt-[15px]">
                                <img src="assets/img/resume/resume.jpg" alt="resume" class="w-full rounded-[20px]">
                            </div>
                            <div class="inner-blog-contact p-[24px] max-[575px]:p-[15px]">
                                <span class="font-montserrat text-[14px] leading-[26px] tracking-[0.02rem] font-normal text-[#777]">App Devloper</span>
                                <h4 class="mb-[8px] font-montserrat text-[20px] font-bold text-[#111a24] tracking-[0.03rem] leading-[1.2] max-[575px]:text-[18px]">Jenny Brown</h4>
                                <p class="m-[0] font-montserrat text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            </div>
                        </div>
                        <div class="bix-categories p-[24px] max-[575px]:p-[15px] border-b-[1px] border-solid border-[#eae8ef]">
                            <div class="sub-title mb-[12px]">
                                <h4 class="font-montserrat text-[18px] font-bold text-[#111a24] tracking-[0.03rem] leading-[1.2] max-[575px]:text-[16px]">Categories</h4>
                            </div>
                            <div class="inner-categories">
                                <ul class="list-disc pl-[2rem] mb-[0]">
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Marketing & Seo</a></li>
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Health & Fitness</a></li>
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Finance & Money</a></li>
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Growth & Income</a></li>
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Fashion & Lifestyle</a></li>
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Food & Drinks</a></li>
                                    <li class="py-[10px] leading-[24px]"><a href="single-project.html" class="font-montserrat leading-[26px] text-[14px] font-normal tracking-[0.03rem] text-[#777]">Parenting & Guide</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="bix-recent-post p-[24px] max-[575px]:p-[15px] border-b-[1px] border-solid border-[#eae8ef]">
                            <div class="sub-title mb-[12px]">
                                <h4 class="font-montserrat text-[18px] font-bold text-[#111a24] tracking-[0.03rem] leading-[1.2] max-[575px]:text-[16px]">Recent Post</h4>
                            </div>
                            <div class="bix-recent-card">
                                <div class="recent-img">
                                    <img src="assets/img/blog/1.jpg" alt="blog-1" class="w-full rounded-[20px]">
                                </div>
                                <div class="recent-contact pt-[24px]">
                                    <span class="font-montserrat text-[13px] font-normal leading-[26px] tracking-[0.02rem] text-[#777]">Marketing</span>
                                    <h4 class="mb-[4px] text-[18px]"><a href="javascript:void(0)" class="font-montserrat leading-[26px] tracking-[0.03rem] text-[18px] font-bold text-[#111a24] max-[575px]:text-[16px]">Marketing Guide 5 steps to Success</a></h4>
                                    <p class="mb-[0] font-montserrat text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officia, illum.</p>
                                </div>
                            </div>
                        </div>
                        <div class="bix-blog-sub-details p-[24px] max-[575px]:p-[15px]">
                            <div class="blog-rows-card flex rounded-[20px] max-[320px]:flex-col mb-[24px]">
                                <div class="blog-image">
                                    <img src="assets/img/blog/1.jpg" alt="blog-1" class="w-[60px] max-[320px]:w-full rounded-[15px]">
                                </div>
                                <div class="inner-contact flex flex-col justify-center pl-[15px] max-[320px]:pl-[0] max-[320px]:pt-[15px]">
                                    <h5 class="mb-[8px] text-[13px]"><a href="blog-detail.html" class="font-montserrat tracking-[0.03rem] text-[14px] font-semibold leading-[22px] text-[#111a24]">Marketing Guide: 5 Steps to Success.</a></h5>
                                    <p class="font-montserrat tracking-[0.03rem] text-[12px] font-normal leading-[16px] text-[#777]">Marketing</p>
                                </div>
                            </div>
                            <div class="blog-rows-card flex rounded-[20px] max-[320px]:flex-col mb-[24px]">
                                <div class="blog-image">
                                    <img src="assets/img/blog/2.jpg" alt="blog-2" class="w-[60px] max-[320px]:w-full rounded-[15px]">
                                </div>
                                <div class="inner-contact flex flex-col justify-center pl-[15px] max-[320px]:pl-[0] max-[320px]:pt-[15px]">
                                    <h5 class="mb-[8px] text-[13px]"><a href="blog-detail.html" class="font-montserrat tracking-[0.03rem] text-[14px] font-semibold leading-[22px] text-[#111a24]">Best way to solve business deal issue.</a></h5>
                                    <p class="font-montserrat tracking-[0.03rem] text-[12px] font-normal leading-[16px] text-[#777]">Business</p>
                                </div>
                            </div>
                            <div class="blog-rows-card flex rounded-[20px] max-[320px]:flex-col mb-[24px]">
                                <div class="blog-image">
                                    <img src="assets/img/blog/3.jpg" alt="blog-3" class="w-[60px] max-[320px]:w-full rounded-[15px]">
                                </div>
                                <div class="inner-contact flex flex-col justify-center pl-[15px] max-[320px]:pl-[0] max-[320px]:pt-[15px]">
                                    <h5 class="mb-[8px] text-[13px]"><a href="blog-detail.html" class="font-montserrat tracking-[0.03rem] text-[14px] font-semibold leading-[22px] text-[#111a24]">31 customer service stats know in 2019.</a></h5>
                                    <p class="font-montserrat tracking-[0.03rem] text-[12px] font-normal leading-[16px] text-[#777]">Tips</p>
                                </div>
                            </div>
                            <div class="blog-rows-card flex rounded-[20px] max-[320px]:flex-col">
                                <div class="blog-image">
                                    <img src="assets/img/blog/4.jpg" alt="blog-4" class="w-[60px] max-[320px]:w-full rounded-[15px]">
                                </div>
                                <div class="inner-contact flex flex-col justify-center pl-[15px] max-[320px]:pl-[0] max-[320px]:pt-[15px]">
                                    <h5 class="mb-[8px] text-[13px]"><a href="blog-detail.html" class="font-montserrat tracking-[0.03rem] text-[14px] font-semibold leading-[22px] text-[#111a24]">Business ideas to grow your business.</a></h5>
                                    <p class="font-montserrat tracking-[0.03rem] text-[12px] font-normal leading-[16px] text-[#777]">Finances</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="min-[992px]:w-[66.66%] w-full px-[12px] mb-[24px]">
                    <div class="bix-blog-contact">
                        <div class="inner-main-contact mb-[24px] border-[1px] border-solid border-[#eae8ef] rounded-[20px]">
                            <div class="main-blog-image">
                                <img src="assets/img/blog/blog-details.jpg" alt="blog-details" class="w-full rounded-t-[20px]">
                            </div>
                            <div class="main-blog-contact p-[24px] border-b-[1px] border-solid border-[#eae8ef] max-[575px]:p-[15px]">
                                <div class="main-title mb-[8px]">
                                    <h4 class="font-montserrat text-[18px] font-bold text-[#111a24] leading-[24px] tracking-[0.03rem] max-[575px]:text-[16px]">Best way to solve business deal issue.</h4>
                                </div>
                                <p class="mb-[0] font-montserrat text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eaque voluptatum commodi
                                    porro delectus reprehenderit laudantium architecto rerum atque adipisci expedita
                                    nihil neque sed quam, fuga aspernatur. Rerum aperiam adipisci quae, temporibus odio
                                    aspernatur, quas nostrum, recusandae quis molestias perferendis velit mollitia omnis
                                    voluptate. Iure minus explicabo esse neque soluta enim.</p>
                            </div>
                            <div class="inner-blog-details-2colum p-[24px] max-[575px]:p-[15px]">
                                <div class="flex flex-wrap mx-[-12px]">
                                    <div class="min-[576px]:w-[50%] w-full px-[12px]">
                                        <div class="inner-blog-image mb-[24px]">
                                            <img src="assets/img/blog/1.jpg" alt="blog-1" class="radius-right w-full rounded-[20px]">
                                        </div>
                                    </div>
                                    <div class="min-[576px]:w-[50%] w-full px-[12px]">
                                        <div class="inner-blog-image mb-[24px]">
                                            <img src="assets/img/blog/2.jpg" alt="blog-2" class="radius-left w-full rounded-[20px]">
                                        </div>
                                    </div>
                                </div>
                                <p class="mb-[0] font-montserrat text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eaque voluptatum commodi
                        ...
                        <div class="inner-replies-contact p-[24px] border-[1px] border-solid border-[#eae8ef] rounded-[20px] max-[575px]:p-[15px]">
                            <div class="main-title mb-[8px]">
                                <h4 class="font-montserrat text-[18px] font-bold text-[#111a24] leading-[24px] tracking-[0.03rem] max-[575px]:text-[16px]">2 Comment</h4>
                            </div>
                            ...
                            <div class="bix-reviews-details">
                                <div class="main-title mb-[16px]">
                                    <h4 class="font-montserrat text-[18px] font-bold text-[#111a24] mb-[24px] tracking-[0.03rem] leading-[1.2]">Add a Comment</h4>
                                </div>
